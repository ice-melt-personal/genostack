...
parser.add_argument('-pmids', default='25282519',
                    help="Comma separated list of pmids to fetch. Must include -pmids or -pmf.")
parser.add_argument('-pmf', default='%#$',
...
parser.add_argument('-out', default="fetched_pdfs",
                    help="Output directory for fetched articles.  Default: fetched_pdfs")
parser.add_argument('-errors', default="fetched_pdfs//unfetched_pmids.txt",
                    help="Output file path for pmids which failed to fetch.  Default: unfetched_pmids.txt")
parser.add_argument('-maxRetries', default=3, type=int,
                    help="Change max number of retries per article on an error 104.  Default: 3", )
